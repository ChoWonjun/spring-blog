...
<script type="text/javascript">
	$(function() {
		$('#postCategory').val('${post.category}').attr('selected', 'selected');
		$('#postOpen').val('${post.open}').attr('selected', 'selected');
...
<header class="intro-header"
	style="background-image: url('${initParam.root}resources/img/bg.jpg')">
	<div class="container">
		<div class="row">
...
<div class="container">
	<div class="row">
		<form class="form-horizontal" role="form" id="update_post_form"
			name="update_post_form" action="${initParam.root}update"
			method="POST">
			...
			<div class="form-group">
				<label for="subTitle" class="col-md-2 control-label">Sub
					Title</label>
				<div class="col-md-8">
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<select class="form-control" id="postOpen" name="open">
						<option>선택</option>
			...
			<!-- submit btn -->
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				<button id="update_post_button">Submit &rarr;</button>
				</ul>
			</div>
		</form>
