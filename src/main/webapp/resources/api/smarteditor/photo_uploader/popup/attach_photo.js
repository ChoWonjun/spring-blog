    ...
    function html5Upload() {	
        ...
        sUploadURL= 'http://localhost:8888/devnote/article/multiplePhotoUpload'; 	//upload URL
    	//sUploadURL= 'http://danielhs.iptime.org/devnote/article/multiplePhotoUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://localhost:8888/devnote/photoUpload',	//샘플 URL입니다.
 	        sCallback : '/resources/api/smarteditor/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
